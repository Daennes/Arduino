========================================================================
    KONSOLENANWENDUNG: Consoleprüfung-Projektübersicht
========================================================================

Diese Consoleprüfung-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Consoleprüfung-Anwendung besteht.


Consoleprüfung.vcxproj
...
Consoleprüfung.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Consoleprüfung.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
